...
<body>
      ...
      <div class="form-wrap">
        ...
        <form action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" required name="raisonsocial" id="raison"  placeholder="Votre raison social" value = "<?php if(isset($_POST['raisonsocial'])) {echo $_POST['raisonsocial'];} ?>" />
          </div>
          ...
          <div class="form-group">
            <label name="motivation">Message</label>
            <!-- <input type="text" name="tel" id="telephone" placeholder="facultatif" /> -->
  ...
  button: "Accueil!",
          ...
          <?php 
           ...
           {
               if(!empty($_POST['nom']) and !empty($_POST['prenom']) and !empty($_POST['raisonsocial']) and !empty($_POST['email']) and !empty($_POST['tel']) and !empty($_POST['message']))
               {
                   $to = "emileliu97320@gmail.com";
                   $from = $_POST['email'];
                   $nom = $_POST['nom'];
                   $prenom = $_POST['prenom'];
                   ...
                   $message = " Nom : " . $_POST['nom'] . "\n\n" . "Raison Sociale : " . $_POST['raisonsocial'] . "\n\n" . $nom. "" .$prenom.  " a ecrit le message suivant : " . "\n\n" . $_POST['message'];
                ...
                elseif(!empty($_POST['nom']) and !empty($_POST['prenom']) and !empty($_POST['raisonsocial']) and !empty($_POST['email']))
                   {   
